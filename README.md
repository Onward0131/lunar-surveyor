# Astra Vibe Coding · Lunar Surveyor｜月面漫游

**使用Astra模型，通过Vibe Coding方式构建的交互式3D月面漫游与航天模型展示项目。**

Vibe-coded with the Astra model: an interactive Three.js lunar explorer featuring 17 rover and spacecraft models, NASA assets, and offline HTML export.

项目基于Three.js，包含**17个模型选项：16套NASA官方发布模型与原创L-03概念车**。支持鼠标旋转、缩放、自由飞行，以及单文件离线体验。

[下载离线版本](https://github.com/Onward0131/astra-vibe-coding-lunar-surveyor/releases/latest) · [模型来源](outputs/NASA模型说明.txt) · [许可说明](NOTICE.md) · [反馈问题](https://github.com/Onward0131/astra-vibe-coding-lunar-surveyor/issues)
...
前往[Releases](https://github.com/Onward0131/astra-vibe-coding-lunar-surveyor/releases/latest)，下载以下任一文件：
...
```sh
git clone https://github.com/Onward0131/astra-vibe-coding-lunar-surveyor.git
cd astra-vibe-coding-lunar-surveyor
npm start
```
...
欢迎通过[Issues](https://github.com/Onward0131/astra-vibe-coding-lunar-surveyor/issues)反馈问题。请附上模型名称、操作步骤、浏览器版本和设备信息，便于复现。
